...
cities = [('Hong Kong, China','294217'), ('Singapore','294265'), ('Bangkok, Thailand','293916'), \
    ...
    ('Lisbon, Portugal','189158'), ('Canc�n, Mexico','150807'), ('Buenos Aires, Argentina','312741'), ('Cairo, Egypt','294201'), \
    ('Punta Cana, Domincan Republic','147293'), ('Suzhou, China','297442'), ('Djerba, Tunisia','297941'), ('Agra, India','297683'), \
    ('Krak�w, Poland','274772'), ('Bucharest, Romania','294458'), ('Siem Reap, Cambodia','297390'), ('Jaipur, India','304555'), \
    ('Honolulu, USA','60982'), ('Manama, Bahrain','293997'), ('Dammam, Saudi Arabia','298547'), ('Hanoi, Vietnam','293924'), \
    ('Andorra La Vella, Andorra','190392'), ('Nice, France','187234'), ('Z�rich, Switzerland','188113'), \
    ('Jakarta, Indonesia','294229'), ('Manila, Philippines','298573'), ('Chiang Mai, Thailand','293917'), \
    ('Marrakech, Morocco','293734'), ('Sharm El Sheikh, Egypt','297555'), ('Marne-La-Vall�e, France','226865'), \
